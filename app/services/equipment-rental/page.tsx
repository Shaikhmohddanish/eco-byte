...
export default function EquipmentRentalPage() {
  ...
  return (
    <>
      <Head>
        <title>IT Equipment Rental Services in Mumbai | Eco-Byte Solution</title>
        <meta name="description" content="Rent laptops, desktops, projectors, and networking equipment in Mumbai. Flexible rental terms, fast delivery, and expert support from Eco-Byte Solution." />
        <meta name="robots" content="index, follow" />
        <meta property="og:title" content="IT Equipment Rental Services in Mumbai | Eco-Byte Solution" />
        <meta property="og:description" content="Get the latest IT equipment on rent for your business, events, or projects. Fast delivery, expert support, and affordable terms." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://eco-byte.com/services/equipment-rental" />
        <meta property="og:image" content="/images/4.jpeg" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="IT Equipment Rental Services in Mumbai | Eco-Byte Solution" />
        <meta name="twitter:description" content="Rent laptops, desktops, projectors, and networking equipment in Mumbai. Flexible rental terms, fast delivery, and expert support from Eco-Byte Solution." />
        <meta name="twitter:image" content="/images/4.jpeg" />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              description: 'Rent laptops, desktops, projectors, and networking equipment in Mumbai. Flexible rental terms, fast delivery, and expert support from Eco-Byte Solution.',
              provider: {
                '@type': 'Organization',
              ...
              url: 'https://eco-byte.com/services/equipment-rental',
              image: 'https://eco-byte.com/images/4.jpeg',
              offers: {
                '@type': 'Offer',
                priceCurrency: 'INR',
