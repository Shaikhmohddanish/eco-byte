  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="fixed bottom-4 right-4 flex flex-col space-y-2">
        <Link href="tel:+919326620089" className="flex items-center justify-center w-12 h-12 rounded-full bg-gradient-to-r from-emerald-600 to-cyan-600 text-white shadow-lg hover:from-emerald-700 hover:to-cyan-700 transition-all">
          <Phone className="w-6 h-6" />
        </Link>
        <Link href="mailto:info@ecobytesolution.com" className="flex items-center justify-center w-12 h-12 rounded-full bg-gradient-to-r from-emerald-600 to-cyan-600 text-white shadow-lg hover:from-emerald-700 hover:to-cyan-700 transition-all">
          <Mail className="w-6 h-6" />
        </Link>
        <Link href="/#contact" className="flex items-center justify-center w-12 h-12 rounded-full bg-gradient-to-r from-emerald-600 to-cyan-600 text-white shadow-lg hover:from-emerald-700 hover:to-cyan-700 transition-all">
