...
export default function LaptopServicesPage() {
  ...
  return (
    <>
      <Head>
        <title>Laptop Services in Mumbai | Eco-Byte Solution</title>
        <meta name="description" content="Professional laptop repair, upgrade, and maintenance services in Mumbai. Fast, reliable, and affordable laptop solutions by Eco-Byte Solution." />
        <meta name="robots" content="index, follow" />
        <meta property="og:title" content="Laptop Services in Mumbai | Eco-Byte Solution" />
        <meta property="og:description" content="Professional laptop repair, upgrade, and maintenance services in Mumbai. Fast, reliable, and affordable laptop solutions." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://eco-byte.com/services/laptop-services" />
        <meta property="og:image" content="/images/1.jpeg" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Laptop Services in Mumbai | Eco-Byte Solution" />
        <meta name="twitter:description" content="Professional laptop repair, upgrade, and maintenance services in Mumbai. Fast, reliable, and affordable laptop solutions by Eco-Byte Solution." />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              description: 'Professional laptop repair, upgrade, and maintenance services in Mumbai. Fast, reliable, and affordable laptop solutions by Eco-Byte Solution.',
              provider: {
                '@type': 'Organization',
              ...
              serviceType: 'Laptop Services',
              url: 'https://eco-byte.com/services/laptop-services',
              image: 'https://eco-byte.com/images/1.jpeg',
              offers: {
                '@type': 'Offer',
                priceCurrency: 'INR',
