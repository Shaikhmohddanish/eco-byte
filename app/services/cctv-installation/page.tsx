...
export default function CCTVInstallationPage() {
  ...
  return (
    <>
      <Head>
        <title>CCTV Installation Services in Mumbai | Eco-Byte Solution</title>
        <meta name="description" content="Professional CCTV installation, setup, and maintenance in Mumbai. Secure your premises with advanced surveillance solutions from Eco-Byte Solution." />
        <meta name="robots" content="index, follow" />
        <meta property="og:title" content="CCTV Installation Services in Mumbai | Eco-Byte Solution" />
        <meta property="og:description" content="Professional CCTV installation, setup, and maintenance in Mumbai. Secure your premises with advanced surveillance solutions." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://eco-byte.com/services/cctv-installation" />
        <meta property="og:image" content="/images/cctv.jpg" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="CCTV Installation Services in Mumbai | Eco-Byte Solution" />
        <meta name="twitter:description" content="Professional CCTV installation, setup, and maintenance in Mumbai. Secure your premises with advanced surveillance solutions from Eco-Byte Solution." />
        <meta name="twitter:image" content="/images/cctv.jpg" />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              description: 'Professional CCTV installation, setup, and maintenance in Mumbai. Secure your premises with advanced surveillance solutions from Eco-Byte Solution.',
              provider: {
                '@type': 'Organization',
              ...
              url: 'https://eco-byte.com/services/cctv-installation',
              image: 'https://eco-byte.com/images/cctv.jpg',
              offers: {
                '@type': 'Offer',
                priceCurrency: 'INR',
