...
export default function DesktopSolutionsPage() {
  ...
  return (
    <>
      <Head>
        <title>Desktop Solutions in Mumbai | Eco-Byte Solution</title>
        <meta name="description" content="Custom desktop PC solutions, setup, and support in Mumbai. High-performance desktops for business, gaming, and creative professionals by Eco-Byte Solution." />
        <meta name="robots" content="index, follow" />
        <meta property="og:title" content="Desktop Solutions in Mumbai | Eco-Byte Solution" />
        <meta property="og:description" content="Custom desktop PC solutions, setup, and support in Mumbai. High-performance desktops for business, gaming, and creative professionals." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://eco-byte.com/services/desktop-solutions" />
        <meta property="og:image" content="/images/3.jpeg" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Desktop Solutions in Mumbai | Eco-Byte Solution" />
        <meta name="twitter:description" content="Custom desktop PC solutions, setup, and support in Mumbai. High-performance desktops for business, gaming, and creative professionals by Eco-Byte Solution." />
        <meta name="twitter:image" content="/images/3.jpeg" />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              description: 'Custom desktop PC solutions, setup, and support in Mumbai. High-performance desktops for business, gaming, and creative professionals by Eco-Byte Solution.',
              provider: {
                '@type': 'Organization',
              ...
              serviceType: 'Desktop Solutions',
              url: 'https://eco-byte.com/services/desktop-solutions',
              image: 'https://eco-byte.com/images/3.jpeg',
              offers: {
                '@type': 'Offer',
                priceCurrency: 'INR',
