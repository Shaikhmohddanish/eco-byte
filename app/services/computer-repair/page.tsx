...
export default function ComputerRepairPage() {
  ...
  return (
    <>
      <Head>
        <title>Computer Repair Services in Mumbai | Eco-Byte Solution</title>
        <meta name="description" content="Expert computer repair, troubleshooting, and maintenance in Mumbai. Fast, reliable, and affordable PC repair services by Eco-Byte Solution." />
        <meta name="robots" content="index, follow" />
        <meta property="og:title" content="Computer Repair Services in Mumbai | Eco-Byte Solution" />
        <meta property="og:description" content="Expert computer repair, troubleshooting, and maintenance in Mumbai. Fast, reliable, and affordable PC repair services." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://eco-byte.com/services/computer-repair" />
        <meta property="og:image" content="/images/2.jpeg" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Computer Repair Services in Mumbai | Eco-Byte Solution" />
        <meta name="twitter:description" content="Expert computer repair, troubleshooting, and maintenance in Mumbai. Fast, reliable, and affordable PC repair services by Eco-Byte Solution." />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              description: 'Expert computer repair, troubleshooting, and maintenance in Mumbai. Fast, reliable, and affordable PC repair services by Eco-Byte Solution.',
              provider: {
                '@type': 'Organization',
              ...
              url: 'https://eco-byte.com/services/computer-repair',
              image: 'https://eco-byte.com/images/2.jpeg',
              offers: {
                '@type': 'Offer',
                priceCurrency: 'INR',
